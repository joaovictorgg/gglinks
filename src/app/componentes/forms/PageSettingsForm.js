      ...
      <div>
        ...
        <form action={saveBaseSettings}>
            ...
            >
             ...
             options={[
                {value:'color', icon: faPalette, label:'Cor'},
                {value:'image', icon: faImage, label:'Imagem'},
             ]}  
             onChange={val => setBgType(val)}
            />
                {bgType === 'color' && (
                  <div className="bg-gray-200 shadow text-gray-700 mt-2 p-2">
         ...
         <div className="flex justify-center -mb-12">
          <div className="relative -top-8 w-[128px] h-[128px]">
            ...
            border-4 border-white shadow shadow-black/50">
             <Image 
            ...
            <label 
              htmlFor="avatarIn"
              className="absolute bottom-0 -right-2 bg-white
              p-2 rounded-full shadow shadow-black/50 aspect-square
              flex items-center cursor-pointer">
              <FontAwesomeIcon size={'xl'} icon={faCloudArrowUp}/>  
              </label>
              <input onChange={handleAvatarImageChange} 
              id="avatarIn" type="file" className="hidden"/>
              <input type="hidden" name="avatar" value={avatar} />
          </div>
         </div>
         <div className="p-0">
            <label className="input-label" htmlFor="nameIn" > Nome de exibição</label>
            <input 
              type="text" 
              id="nameIn" 
              name="displayName" 
            ...
            <label className="input-label" htmlFor="bioIn" > Biografia</label>
            <textarea 
              name="bio"
              defaultValue={page.bio} 
              id="bioIn" 
              placeholder="A sua biografia fica aqui..." />
